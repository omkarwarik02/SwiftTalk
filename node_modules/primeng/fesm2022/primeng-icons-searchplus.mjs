...
class SearchPlusIcon extends BaseIcon {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.3", ngImport: i0, type: SearchPlusIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.0.3", type: SearchPlusIcon, isStandalone: true, selector: "[data-p-icon=\"search-plus\"]", usesInheritance: true, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.3", ngImport: i0, type: SearchPlusIcon, decorators: [{
            type: Component,
            args: [{
