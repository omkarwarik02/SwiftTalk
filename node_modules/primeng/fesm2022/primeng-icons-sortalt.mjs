...
class SortAltIcon extends BaseIcon {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.3", ngImport: i0, type: SortAltIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.0.3", type: SortAltIcon, isStandalone: true, selector: "[data-p-icon=\"sort-alt\"]", usesInheritance: true, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.3", ngImport: i0, type: SortAltIcon, decorators: [{
            type: Component,
            args: [{
